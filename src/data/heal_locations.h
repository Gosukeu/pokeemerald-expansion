static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EMBERFALL_TOWN - 1] = {MAP_GROUP(EMBERFALL_TOWN), MAP_NUM(EMBERFALL_TOWN), 33, 58},
    [HEAL_LOCATION_AEGISPORT - 1] = {MAP_GROUP(AEGISPORT), MAP_NUM(AEGISPORT), 8, 17},
    [HEAL_LOCATION_POKE_CENTER_EMBERFALL_TOWN - 1] = {MAP_GROUP(POKE_CENTER_EMBERFALL_TOWN), MAP_NUM(POKE_CENTER_EMBERFALL_TOWN), 7, 4},
    [HEAL_LOCATION_POKE_CENTER_1_AEGISPORT - 1] = {MAP_GROUP(POKE_CENTER_1_AEGISPORT), MAP_NUM(POKE_CENTER_1_AEGISPORT), 7, 4},
    [HEAL_LOCATION_TUNDRAWOOD_CITY - 1] = {MAP_GROUP(TUNDRAWOOD_CITY), MAP_NUM(TUNDRAWOOD_CITY), 40, 30},
};
