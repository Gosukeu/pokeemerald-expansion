...
#define HEAL_LOCATION_EMBERFALL_TOWN 24
#define HEAL_LOCATION_AEGISPORT 25
#define HEAL_LOCATION_POKE_CENTER_EMBERFALL_TOWN 26
#define HEAL_LOCATION_POKE_CENTER_1_AEGISPORT 27
#define HEAL_LOCATION_TUNDRAWOOD_CITY 28
